...
export default async function TermsOfServicePage() {
  ...
  return (
    ...
    >
      ...
      <p>
        {platformName} is an API marketplace platform that connects API providers with developers and enterprises. The Service includes the following features and services:
      </p>
      <p><strong>Marketplace and discovery:</strong></p>
      <ul>
        <li>Browse, search, and compare APIs; API bundles and collections; public directory and documentation</li>
      </ul>
      <p><strong>For API providers:</strong></p>
      <ul>
        <li>Publish and manage APIs with OpenAPI specs, documentation, pricing plans, and versions</li>
        <li>Stripe Connect integration for payouts; usage-based billing and subscription management</li>
        <li>Analytics, usage dashboards, and API readiness audits</li>
        <li>Affiliate and referral programs; API claim and ownership verification</li>
      </ul>
      <p><strong>For developers:</strong></p>
      <ul>
        <li>Subscribe to APIs; manage API keys and credentials; usage and cost intelligence dashboards</li>
        <li>AI-powered playground and code generation; test APIs before integrating</li>
        <li>Favorites, collections, challenges, and community forum</li>
        <li>Referral program; workflows; support tickets and notifications (email, in-app, webhooks)</li>
      </ul>
      <p><strong>Enterprise and governance:</strong></p>
      <ul>
        <li>Governance controls, audit logs, and cost control features where offered</li>
      </ul>
      <p>
      ...
      <h2 id="enterprise-additional">9. Enterprise, Referrals & Additional Services</h2>
      <p>
        <strong>Enterprise:</strong> Enterprise offerings may include custom SLAs, governance, audit logs, and cost controls. Terms for enterprise plans may be set out in a separate order form or agreement.
      </p>
      <p>
        <strong>Referrals and affiliates:</strong> We may offer referral or affiliate programs that reward users for referring new customers. You must comply with any program terms and applicable law; referral or affiliate abuse (e.g., self-referral, fake traffic) may result in forfeiture of rewards and account action.
      </p>
      <p>
        <strong>Webhooks and notifications:</strong> You may configure webhooks or notification preferences to receive events (e.g., billing, usage, API events). You are responsible for securing webhook endpoints and handling payloads in accordance with our documentation and data protection obligations.
      </p>
      <p>
        <strong>AI and code generation:</strong> AI-powered features (e.g., code generation, playground suggestions) are provided &quot;as is.&quot; We do not guarantee accuracy or fitness for a particular use. You are responsible for reviewing and testing any generated code before use.
      </p>

      <h2 id="sla">10. Service Level Expectations</h2>
      <p>
      ...
      <h2 id="content-moderation">11. Content Moderation</h2>
      <p>
      ...
      <h2 id="warranties">14. Warranties and Disclaimers</h2>
      ...
      <h2 id="export">18. Export Compliance</h2>
      <p>
      ...
      <h2 id="third-party">19. Third-Party Services</h2>
      <p>
      ...
      <h2 id="governing-law">20. Governing Law and Jurisdiction</h2>
      <p>
      ...
      <h2 id="arbitration">21. Dispute Resolution and Arbitration</h2>
      <p>
      ...
      <h2 id="class-waiver">23. Class Action Waiver</h2>
      <p>
      ...
      <h2 id="entire-agreement">24. Entire Agreement</h2>
      <p>
