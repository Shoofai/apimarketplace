  ...
  if (state === 'success') {
    return (
      <div className="flex flex-col items-center gap-3 py-4 text-center">
        ...
        <p className="font-medium text-gray-900 dark:text-white">Code accepted!</p>
        <p className="text-sm text-gray-500 dark:text-gray-400">Taking you in…</p>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="space-y-1.5">
        <Label htmlFor="ea-code">Invite code</Label>
        <Input
          id="ea-code"
