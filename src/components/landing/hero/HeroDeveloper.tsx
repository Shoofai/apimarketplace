    ...
    >
      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col justify-center px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        ...
        >
          ...
          <motion.p
            variants={slideUp}
            className="mb-4 max-w-3xl font-medium leading-relaxed text-gray-700 text-subhero sm:mb-6 dark:text-primary-100"
          >
          ...
          <motion.div
            variants={slideUp}
            className="mb-5 flex flex-wrap justify-center gap-4 text-sm text-gray-600 sm:mb-6 sm:gap-6 dark:text-primary-100/90"
          >
          ...
          <motion.div
            variants={slideUp}
            className="mb-5 w-full max-w-2xl rounded-xl border border-white/20 bg-white/10 px-4 py-3 ring-1 ring-primary-500/20 sm:mb-6 dark:border-white/10 dark:bg-gray-900/80 dark:ring-primary-500/20"
          >
          ...
          <motion.div variants={fadeIn} className="mb-6 sm:mb-8">
            <p className="mb-3 text-xs uppercase tracking-wider text-gray-600 dark:text-white/70">Integrate with thousands of apps, including:</p>
          ...
          <motion.div
            variants={fadeIn}
            className="flex w-full max-w-4xl flex-wrap items-center justify-center gap-4 rounded-2xl border-2 border-gray-200 bg-white/80 px-8 py-8 shadow-xl backdrop-blur-xl dark:border-white/10 dark:bg-white/5"
          >
